...
knitr::opts_knit$set(root.dir = "~/Downloads/rrBLUP")
setwd("~/Downloads/rrBLUP")
...
#load marker data
marker <- read.table(file = '/data/rrBLUP_Example_SNP.txt', header = FALSE) #load marker data
marker
...
phen <- read.table(file = 'data/rrBLUP_Example_Traits.txt', header = TRUE) #load phenotypic data
phen
dim(phen)
```
...
#2 genotypes (training and prediction)
...
#check accuracy
dev.new()
pdf(file = 'data/Plot_GS_Example.pdf', height = 6, width = 6)
